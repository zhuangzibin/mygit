...
<meta content="134" name="bai" />
<link rel="stylesheet" href="${ctx}/js/metronic/css/reg.css" type="text/css" />
...
<script src="${ctx}/js/metronic/scripts/app.js" type="text/javascript"></script>
<script src="${ctx}/js/metronic/scripts/lock.js" type="text/javascript"></script>
...
<script type="text/javascript">
	...
	function changeBtnable(){
		...
		$("#login-submit-btn").removeClass("grey");
		$("#login-submit-btn").addClass("red");
	...
	function changeBtndisable(){
		...
		$("#login-submit-btn").removeClass("red");
		$("#login-submit-btn").addClass("grey");
		$("#lo").addClass("red");
		$("#lo").removeAttr("disabled");
	}
	function checkInput(){
		...
		if(password==null||password==""||loginname==nullloginname==""){
			changeBtndisable();
		}else{
			changeBtnable();
		}
...
<body style="font-family: 微软雅黑">
	<div class="page-lock">
		<div class="page-logo" style="margin-bottom: 2px" >
			...
			<!--  a  class="brand" 
				style="font-size: 22px; color: #FFF; text-decoration:none" href="#"> 人事管理<font color="#FFCC00">HRM</font><span
				style="font-size: 13px;">1.0</span> 系统
	
			/a-->
			<p align="center" ><font size="5">公司人事档案管理系统</font></p>
		</div>
		<form action="login" method="post" id="loginForm">
			<div class="page-body">
				<img class="page-lock-img"
					src="${ctx }/js/metronic/img/profile/logo2.jpg" alt="图片显示不出">
				<div class="page-lock-info">
					<span>&nbsp;</span> 
					<c:choose>
						<c:when test="${requestScope.message == null }">
							<span style="padding-top: 5px"><font color="green">允许以中文名称登录</font></span>
						</c:when>
						<c:otherwise>
						...
						<div class="controls">
							<div class="input-icon left">
								<i class="icon-user"></i> <input
									...
									id="loginname" name="loginname" value="${loginname}" onmouseleave="checkInput()" oninput="changeBtnable()" />
							</div>
						</div>
					</div>
					<div class="control-group">
						<div class="controls">
							<div class="input-icon left">
								<i class="icon-lock"></i> <input
									...
									value="${password}" onmouseleave="checkInput()" oninput="changeBtnable()" />
							</div>
						</div>
					</div>
				</div>
				<div class="relogin">
						<!-- 单击登录 -->
						<button type="submit" id="login-submit-btn" class="btn" disabled
							style="margin-left: 20px">
							登录 <i class="m-icon-swapright m-icon-white"></i>
						</button>
							<button type="reset" id="lo" class="btn" disabled
							style="margin-left: 20px">
